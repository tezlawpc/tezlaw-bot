...
<aside class="sidebar">
  ...
  <nav style="visibility:hidden;">
    ...
    <div class="nav-section" id="section-work">
      ...
      <a href="/admin/mobile" class="nav-link" data-perm="mobile.search">
    ...
    <div class="nav-section" id="section-intake">
      ...
      <a href="/admin/panel/intakes" class="nav-link" data-perm="matters.access">
        <span class="nav-icon">◊</span><span class="nav-label">Intakes</span>
      </a>
      <a href="/admin/panel/messages" class="nav-link" data-perm="matters.access">
    ...
    <div class="nav-section" id="section-research">
      ...
      <a href="/admin/panel/research" class="nav-link" data-perm="matters.access">
        <span class="nav-icon">◇</span><span class="nav-label">Legal Research</span>
      </a>
      <a href="/admin/panel/post" class="nav-link" data-perm="matters.access">
        <span class="nav-icon">▤</span><span class="nav-label">Post Creator</span>
      </a>
      <a href="/admin/panel/questions" class="nav-link" data-perm="matters.access">
        <span class="nav-icon">◌</span><span class="nav-label">Questions</span>
      </a>
      <a href="/admin/panel/scores" class="nav-link" data-perm="matters.access">
    ...
    <div class="nav-section" id="section-integrations">
      ...
      <a href="/admin/outlook-sync" class="nav-link ${isActive('outlook')}" data-perm="outlook.setup">
...
function renderNoteForm({ noteId = null, generated = null, saved = false, sent = null, error = null, prev = {}, merged = false, revisions = [] } = {}) {
  ...
  <!-- Dictation pill — shown while recording AND while transcribing.
       Deliberately small and faded: the form underneath stays the thing you
  ...
  <style>
    ...
    #dictation-widget.d-transcribing { border-radius: 12px; }
  </style>

  <!-- Review card — appears once the transcript is back. Docked in the corner
  ...
  <script>
    ...
    async function openDictationModal() {
      ...
      dMediaRecorder.onstop = () => {
        ...
        // The pill stays up and turns into a progress indicator. Nothing covers
        // the form, so the attorney keeps typing while Whisper works.
    ...
    async function dProcessRecording(blob) {
      // Turn the pill into a progress indicator. No modal, no backdrop: the
      // form underneath stays editable for the whole transcription.
      ...
      const t1 = setTimeout(() => dProgress(50, "Transcribing…"), 2000);
      const t2 = setTimeout(() => dProgress(80, "Extracting…"), 8000);
